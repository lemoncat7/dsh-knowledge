...
test('browser bundle supports legacy conversation and new keyed main workspaces', async () => {
  ...
  assert.match(source, /WritebackStatusClient/)
  ...
  assert.match(source, /KnowledgeConnectionCard/)
  assert.match(source, /id:\s*"knowledge"/)
  assert.match(source, /knowledge-writeback-status/)
