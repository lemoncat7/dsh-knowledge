...
test('public API routes enforce the read/propose/write/admin capability matrix', async (t) => {
  ...
  const cases = [
    ...
    { required: 'read', method: 'GET', path: '/notes/missing/versions' },
    { required: 'read', method: 'POST', path: '/notes/import-share/inspect', body: {} },
    ...
    { required: 'write', method: 'POST', path: '/knowledge-bases/group', body: { ids: ['default'], group: '工作' } },
    ...
    { required: 'write', method: 'POST', path: '/candidates/bulk-review', body: {} },
    { required: 'write', method: 'POST', path: '/notes/folders', body: {} },
    { required: 'write', method: 'POST', path: '/notes/import-share', body: {} },
    { required: 'write', method: 'POST', path: '/notes/missing/versions/1/restore', body: { expectedVersion: 1 } },
    ...
    { required: 'admin', method: 'GET', path: '/notes/shares' },
