...
test('management console serves a secured same-origin application', async (t) => {
  ...
  assert.match(application, /sidebar\?\.toggleAttribute\('inert', hidden\)/)
  ...
  assert.match(styles, /--material-panel: rgb\(255 255 255 \/ 82%\)/)
  assert.match(styles, /--accent: #3a3a3c/)
  assert.match(styles, /--glass-filter: saturate\(1\.2\) contrast\(1\.035\) blur\(20px\)/)
