...
test('management console serves a secured same-origin application', async (t) => {
  ...
  assert.match(application, /noteMenuAction\('标题大纲', 'outline'/)
  ...
  assert.match(styles, /\.notes-document-actions > \[data-note-mobile-overflow\], \.notes-save-state \{ display: none; \}/)
