...
test('management console serves a secured same-origin application', async (t) => {
  ...
  assert.match(styles, /\.sidebar\.knowledge-glass-surface \{[\s\S]*?background: var\(--material-sidebar\);[\s\S]*?backdrop-filter: none;/)
  assert.match(styles, /\.topbar\.knowledge-glass-surface,[\s\S]*?background: var\(--material-toolbar\);[\s\S]*?backdrop-filter: none;/)
  assert.match(styles, /\.note-tree-panel\.knowledge-glass-surface,[\s\S]*?background: var\(--surface-pane\);[\s\S]*?backdrop-filter: none;/)
