...
const STATIC_ASSETS = new Map<string, Asset>([
  ...['model-catalog', 'dialogs', 'select-control', 'document-actions', 'document-sync', 'document-sync-ui', 'writeback-workspace', 'writeback-live', 'base-groups', 'document-groups'].map(name => [
  ...
  ['note-excerpt.js', loadAsset('../web/note-excerpt.js', 'text/javascript; charset=utf-8')],
